...
1. **Clone the repository:**
   ...
   ```
   git clone https://github.com/navraj771s/Extracting-Structured-Data-From-PDFs
...
Navraj is a Cloud Engineer with over 3 years of experience designing and optimizing secure, scalable cloud infrastructures on AWS. He specializes in CI/CD, Terraform, and Kubernetes, with a focus on building high-availability environments and automating deployments. This project serves as a demonstration of integrating AI-driven data extraction with robust, containerized deployment workflows.

- **Email**: navraj771s@gmail.com
- **GitHub**: https://github.com/navraj771s